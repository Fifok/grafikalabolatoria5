...
public class Lab5 extends GLJPanel implements GLEventListener, KeyListener{
	...
	private void draw(GL2 gl2) {
		...
		if(objectNumber==1) //Korkociag
		{
			...
			for (float i = 0.0f; i<= (java.lang.Math.PI * 2f * n); i += distance) {
	...
	private void drawPyramidSides(GL2 gl2, float height,int size,int n) {
